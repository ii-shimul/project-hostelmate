	...
	return (
		<div className="mt-6 lg:mt-10 bg-secondary dark:bg-inherit py-5 lg:py-12 px-4">
			<div className="max-w-7xl mx-auto">
				...
				<motion.div
					className="grid lg:grid-cols-3 md:grid-cols-2 gap-12 max-md:max-w-lg mx-auto"
					variants={container}
					initial="hidden"
					whileInView="visible"
				...
				>
					<motion.div
						className="rounded-xl group p-8 text-center hover:bg-white  hover:text-primary hover:shadow-xl transition duration-300"
						variants={item}
						whileHover={{ y: -4 }}
					...
					>
						...
						<h3 className="text-xl font-semibold mb-3">Delicious Meals</h3>
						<p className="text-gray-500 group-hover:text-gray-600 text-sm">
							Find and enjoy homemade meals shared by locals in your
							neighborhood.
						</p>
					</motion.div>
					<motion.div
					...
					>
						...
						<p className="text-gray-500 group-hover:text-gray-600 text-sm">
							Discover tasty meals at prices that fit your budget perfectly.
						</p>
					</motion.div>
					<motion.div
						className="rounded-xl group p-8 text-center hover:bg-white  hover:text-primary hover:shadow-xl transition duration-300"
