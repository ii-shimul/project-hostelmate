  ...
  return (
    <>
      <div className="font-[sans-serif] py-4">
        <div className="grid lg:grid-cols-4 grid-cols-2 gap-x-6 gap-y-12 divide-x divide-gray-300">
          ...
          <div className="text-center">
            ...
            <p className="text-base text-gray-800 dark:text-gray-400 font-semibold mt-3">Meals</p>
          </div>
        </div>
      </div>
